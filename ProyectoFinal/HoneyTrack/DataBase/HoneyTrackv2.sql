...
INSERT INTO `RAW_MATERIAL` VALUES ('AIF6P','Internal Storage Z Flip 6','128 GB UFS 3.1 Storage',900.00,0.60,0.65,0.15,20.00,0.59,162),('AIS24','Internal Storage S24','128 GB UFS 3.1 Storage',900.00,0.60,0.65,0.15,20.00,0.59,100),('AIS4P','Internal Storage S24+','256 GB UFS 3.1 Storage',1260.00,0.65,0.65,0.15,30.00,0.63,160),('AIUM5','Internal Storage S24 Ultra','256 GB UFS 3.1 Storage',1440.00,0.70,0.70,0.15,30.00,0.73,164),('AIZF6','Internal Storage Z Fold 6','256 GB UFS 3.1 Storage',1620.00,0.70,0.70,0.15,30.00,0.73,168),('BALS2','Li-ion Battery S24','3900 mAh Battery',270.00,0.60,7.50,0.30,45.00,1.35,100),('BAZF6','Li-ion Battery Z Fold 6','4500 mAh Battery',450.00,0.70,8.00,0.40,60.00,2.24,168),('BFLP6','Li-ion Battery Z Flip 6','3500 mAh Battery',360.00,0.70,8.00,0.30,50.00,1.68,162),('BLA4S','Li-ion Battery S24+','4900 mAh Battery',360.00,0.70,8.00,0.35,55.00,1.96,160),('BLUM5','Li-ion Battery S24 Ultra','5000 mAh Battery',450.00,0.75,8.00,0.40,65.00,2.24,164),('CAZ6F','Front Camera Z Flip 6','10 MP Camera',450.00,0.50,3.50,0.20,8.00,0.35,162),('CCS24','Chassis S24','Aluminum Chassis with Gorilla Glass Victus 2',1080.00,7.50,16.00,0.80,100.00,9.60,100),('CCS4P','Chassis S24+','Aluminum Chassis with Gorilla Glass Victus 2',1170.00,8.00,16.50,0.85,120.00,11.00,160),('CCUM5','Chassis S24 Ultra','Aluminum Chassis with Gorilla Glass Victus 2',1620.00,8.50,17.00,0.90,150.00,13.00,164),('CCZ6P','Chassis Z Flip 6','Samsung Galaxy Z Flip 6 Outer Chassis',740.00,8.60,7.40,1.60,50.00,101.10,162),('CCZF6','Chassis Z Fold 6','Samsung Galaxy Z Fold 6 Outer Chassis',1200.00,16.20,7.60,1.60,75.00,198.72,168),('CFS24','Front Camera S24','12 MP Camera',360.00,0.50,3.50,0.20,8.00,0.35,100),('CFS4P','Front Camera S24+','12 MP Camera',450.00,0.50,3.50,0.25,10.00,0.44,160),('CFUM5','Front Camera S24 Ultra','12 MP Camera',540.00,0.55,3.50,0.30,12.00,0.58,164),('CFZ6F','Front Camera Z Fold 6','10 MP Camera',540.00,0.50,3.50,0.20,8.00,0.35,168),('CPS24','Main Camera S24','50 MP Wide-angle Camera',540.00,0.50,6.00,0.25,12.00,0.75,100),('CPS4P','Main Camera S24+','50 MP Wide-angle Camera',630.00,0.50,6.00,0.25,15.00,0.75,160),('CPU5S','Main Camera S24 Ultra','200 MP Wide-angle Camera',1080.00,0.70,6.50,0.30,20.00,1.37,164),('CPZF6','Main Camera Z Fold 6','50 MP Wide-angle Camera',720.00,0.50,6.00,0.25,15.00,0.75,168),('CZF6P','Main Camera Z Flip 6','50 MP Wide-angle Camera',720.00,0.50,6.00,0.25,12.00,0.75,162),('MAZ6F','RAM Memory Z Flip 6','8 GB LPDDR5 RAM',720.00,0.70,1.00,0.15,25.00,1.05,162),('MR8SP','RAM Memory 8GB S24+','8 GB LPDDR5 RAM',810.00,0.70,1.00,0.15,30.00,1.05,160),('MRS24','RAM Memory S24','8 GB LPDDR5 RAM',720.00,0.70,1.00,0.15,25.00,1.05,100),('MRUM5','RAM Memory S24 Ultra','12 GB LPDDR5 RAM',1080.00,0.75,1.00,0.20,35.00,1.40,164),('MRZ6F','RAM Memory Z Fold 6','12 GB LPDDR5 RAM',1260.00,0.70,1.00,0.20,40.00,1.40,168),('PAMS2','AMOLED Screen S24','Dynamic AMOLED 2X Screen 6.1 120 Hz HDR10+',3600.00,6.10,13.06,0.07,35.00,2.60,100),('PAUM5','AMOLED Screen S24 Ultra','Dynamic AMOLED 2X Screen 6.8 120 Hz HDR10+',5400.00,6.80,15.50,0.09,70.00,4.40,164),('PB4S4','Motherboard S24+','Motherboard with All Integrated Components',1980.00,7.50,11.50,0.30,130.00,26.00,160),('PBBS2','Motherboard S24','Motherboard with All Integrated Components',1800.00,7.00,10.00,0.30,120.00,21.00,100),('PBU5S','Motherboard S24 Ultra','Motherboard with All Integrated Components',2700.00,8.00,12.00,0.35,150.00,33.60,164),('PBZ6F','Motherboard Z Flip 6','Motherboard with All Integrated Components',1800.00,7.00,10.00,0.30,120.00,21.00,162),('PBZF6','Motherboard Z Fold 6','Motherboard with All Integrated Components',2700.00,8.00,12.00,0.35,150.00,33.60,168),('PE4SP','Processor Exynos S24+','Qualcomm Snapdragon 8 Gen 3',3780.00,0.70,0.70,0.25,12.00,0.12,160),('PEF6L','Exterior Screen Super AMOLED Z Fold 6','Dynamic AMOLED 2X Screen 6.2',2700.00,6.20,13.00,0.70,35.00,2.50,168),('PEF6P','Exterior Screen Super AMOLED Z Flip 6','Super AMOLED Screen 1.9',1800.00,1.90,6.00,0.70,15.00,0.80,162),('PES24','Processor Exynos S24','Qualcomm Snapdragon 8 Gen 3',3600.00,0.70,0.70,0.25,10.00,0.12,100),('PEUM5','Processor Exynos S24 Ultra','Qualcomm Snapdragon 8 Gen 3',4500.00,0.80,0.80,0.30,15.00,0.24,164),('PFLP6','Main Screen Flex AMOLED Z Flip 6','Dynamic AMOLED 2X Foldable Screen 6.7',5400.00,6.70,15.00,0.80,55.00,3.50,162),('PFOL6','Main Screen Flex AMOLED Z Fold 6','Dynamic AMOLED 2X Foldable Screen 7.6',6300.00,7.60,16.00,0.80,70.00,5.50,168),('PMA4S','AMOLED Screen S24+','Dynamic AMOLED 2X Screen 6.7 120 Hz HDR10+',4500.00,6.70,14.50,0.08,55.00,3.50,160),('PSZ6F','Processor Snapdragon Z Flip 6','Qualcomm Snapdragon 8 Gen 3',3780.00,0.70,0.70,0.25,10.00,0.12,162),('PSZF6','Processor Snapdragon Z Fold 6','Qualcomm Snapdragon 8 Gen 3',3600.00,0.70,0.70,0.25,10.00,0.12,168);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`cisco`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_EmployeeXUser` AS select `e`.`num` AS `num`,`e`.`firstName` AS `firstName`,`e`.`lastName` AS `lastName`,`e`.`middleName` AS `middleName`,`u`.`username` AS `username`,`u`.`password` AS `password`,`e`.`phone` AS `phone`,`e`.`email` AS `email`,`e`.`taxId` AS `taxId`,`j`.`description` AS `description`,`e`.`employeeStatus` AS `status` from ((`EMPLOYEE` `e` join `USER` `u` on((`e`.`num` = `u`.`employee`))) join `JOB_POSITION` `j` on((`j`.`code` = `e`.`jobPosition`))) order by `e`.`num` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-12-03 22:28:51
